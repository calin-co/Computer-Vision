...
parametri.numeDirectorExempleTest = fullfile(numeDirectorSetDate,'exempleTest/Curs+LaboratorIA');                                    %exemple test din dataset-ul CMU+MIT
...
parametri.threshold = 0.45;                       %toate ferestrele cu scorul > threshold si maxime locale devin detectii
...
% pasul optional este mai jos. am rulat o singura data functia
% obtineExemplePuternicNegative dupa care am salvat prin intermediul consolei 
%descriptorii in descriptoriExempleNegative 
% exemplePuternicNegative = obtineExemplePuternicNegative(parametri);


%% 
% Pasul 4. Ruleaza d    etectorul facial pe imaginile de test.
